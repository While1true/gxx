...
public class RouteLineAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.activity_transit_item, parent,false);
        ...
        switch (mtype) {
            ...
            case BIKING_ROUTE:
                ...
                holder.name.setText(StepUtils.getBusStepTitle((TransitRouteLine) routeLine));
            ...
            case MASS_TRANSIT_ROUTE:
                ...
                holder.name.setText("线路" + (position + 1)+massTransitRouteLine.getAllStep().get(0).toString());
    ...
    private static class NodeViewHolder {
